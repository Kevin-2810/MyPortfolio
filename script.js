...
const projectCategories=[
  ...
  },
  {
    ...
    projects:[
      ...
      {title:'Clash Of Clans',desc:'A game-inspired landing theme with bold visuals and immersive content blocks.',tech:['HTML','CSS','JS'],emoji:'./assets/coc.jpg',bg:'linear-gradient(135deg,#0A1500,#1A2E00)',link:'https://github.com/Kevin-2810/clash-of-clan'},
